...
const proxy = [
    {
        ...
        target: process.env.BACKEND ? process.env.BACKEND === "remote" ? "https://www.stefanwimmer128.eu" : process.env.BACKEND : __devServer ? "http://0.0.0.0:5000" : "https://www.stefanwimmer128.eu",
        changeOrigin: true,
    },
];
